...
pub(crate) trait OAuthFlow: Send + Sync {
    ...
    /// Wired up in PR2 (refresh + 401 retry); unused in PR1.
    #[allow(dead_code)]
...
#[allow(dead_code)] // wired in PR3 when codex registers
