//! Codex CLI HTTP fingerprint shared between the OAuth refresh client
//! and the openai-responses egress defaults.
//!
...
//!     defaults (`default_codex_identity_headers`) read these
//!     constants so a zero-config ChatgptOauth provider emits a full
//!     codex fingerprint.
//!
