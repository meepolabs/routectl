//! Provider trait. Every backend (openai-compat, anthropic-api, claude-cookie,
//! chatgpt-cookie) implements this. Reasoning normalization is mandatory:
//! request -> provider-shape, provider-shape -> response, chunks -> normalized chunks.
