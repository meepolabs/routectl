...
fn outgoing_emit_redacts_authorization_and_x_api_key() {
    ...
    let live_jwt =
        b"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.payload-with-account-id-and-jti.sig";
    let api_key = b"sk-ant-api03-0123456789abcdef";
    ...
    assert!(
        !headers.contains("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9"),
    ...
    assert!(
        !headers.contains("sk-ant-api03-0123456789abcdef"),
