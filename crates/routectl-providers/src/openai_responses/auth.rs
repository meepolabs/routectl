...
//!   ```
//!   The codex CLI identity / fingerprint headers (originator,
...
/// identity / fingerprint headers now flow through `header_extras`
...
mod tests {
    ...
    /// identity / fingerprint headers (originator, residency, version,
