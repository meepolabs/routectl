...
//!
//! Three auth surfaces (only one operational as of the relevant stage):
//!
...
//!
//! the relevant stage wires `complete()` and `stream()` end-to-end for the
...
//! live-smoke gate lands in the relevant stage.
