...
- **Claude Code Remote Control passthrough** -- optional `[mitm]` local front-proxy that lets Claude Code route inference through routectl while keeping Remote Control working against `api.anthropic.com`. Default off; see [`docs/REMOTE-CONTROL.md`](docs/REMOTE-CONTROL.md).
